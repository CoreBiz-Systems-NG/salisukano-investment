			...
			>
				...
				>
					...
					>
						<img
							src="./logo.jpg"
							className="z-30 h-8 w-auto rounded-full"
							alt="logo"
						/>
						<span
				...
				<div className="w-full flex flex-col max-h-screen h-full overflow-y-scroll">
					<div className="pt-5 pl-8 pr-7 py-5 bg-white flex justify-between gap-2 ">
						<div className="hidden sm:flex max-w-2xl justify-between w-full">
							<div className="flex flex-col">
								<span className="text-base md:text-xl text-[#212B36] font-semibold">
									Hello {user?.name?.slice(0, 10) || 'Abdul'}!
								</span>
						...
						<div className="flex gap-2 items-center sm:hidden">
							<img src="/assets/admin/dashboard/user1.svg" alt="logo" />
							<span className="text-xl font-semibold ">Salisu</span>
						</div>
						<div
					...
					<div className="w-full ">
						<Outlet openSideBar={openSideBar} />
					</div>
				</div>
			</div>
			{
