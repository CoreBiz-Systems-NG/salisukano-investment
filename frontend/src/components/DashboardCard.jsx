...
const Card = ({ openSideBar, data }) => {
	return (
		<div className="w-full flex flex-wrap sm:grid grid-cols-2 grid-flow-row md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-5 col-span-12">
			...
			{/* <div className="p-5  bg-white flex flex-col  md:max-w-xs 2xl:max-w-none w-full rounded-xl gap-2 border border-[#E7E7E7] hover:shadow-xl cursor-pointer">
				...
				>
					<h2 className="text-[#637381] text-sm font-medium">Ledger Balance</h2>
				</div>
				<div
					className={`flex gap-4  justify-between ${
						openSideBar
