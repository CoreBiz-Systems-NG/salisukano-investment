				...
				>
					<thead className="bg-[#222E3A]/[6%] rounded-lg text-base text-white font-semibold w-full">
						<tr className="">
							...
							<th className="py-3 text-[#212B36] text-sm font-normal whitespace-nowrap  uppercase md:w-[100px]">
								Name
							</th>
					...
					<tbody>
						{filteredData?.map((data, index) => (
							...
							>
								...
								<td
									onClick={() => handelClick(data?._id)}
									className="py-2 px-2.5 text-sm font-normal text-[#637381] whitespace-nowrap cursor-pointer capitalize"
								>
									{data?.name}
								</td>
								<td
