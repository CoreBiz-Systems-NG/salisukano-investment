...
const Pagination = ({
	...
	return (
		<div className="flex flex-col sm:flex-row justify-end md:justify-between items-center sm:flex-wrap mx-4 w-full">
			...
			<div className="pagination py-3 flex justify-end items-center mx-8">
				<button
					...
					className="inline-block rounded-md w-10 h-10 text-center leading-[33px] border border-gray mr-2 last:mr-0 hover:bg-blue-500	hover:text-white hover:border-blue-500"
				>
					<svg
						className="-translate-y-[2px] -translate-x-px ml-2"
						width="12"
						height="12"
						viewBox="0 0 12 24"
						fill="none"
				...
				<button
					disabled
					className="inline-block rounded-md w-10 h-10 text-center leading-[33px] border mr-2 last:mr-0 text-white bg-blue-500 border-blue-500 hover:bg-blue-500 hover:text-white hover:border-blue-500"
				>
					{state.pageIndex + 1}
				</button>
				{canNextPage && (
				...
				<button
					...
					leading-[33px] border border-gray mr-2 last:mr-0 hover:bg-blue-500
					hover:text-white hover:border-blue-500"
				>
					<svg
						className="-translate-y-px ml-2"
						width="12"
						height="12"
						viewBox="0 0 12 24"
						fill="none"
